...
This requires an OS that uses systemd and NetworkManager, which is the vast majority of major Linux distributions. However, it was created primarily for Zorin OS. Distros such as Ubuntu and Mint should also be supported. To test if this fix would work for you, run the following command:
